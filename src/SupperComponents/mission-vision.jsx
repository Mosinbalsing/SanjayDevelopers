...
export const MissionVision = () => {
  ...
  return (
    <div
      className="container px-12 py-12 h-[300px] bg-[#2E2752]" // Static height applied
    ...
    >
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 h-full">
        ...
        <div className="space-y-8">
          <Tabs defaultValue="about" className="w-full h-full bg-transparent">
            <TabsList
            ...
            >
              <TabsTrigger
                value="about"
                className="data-[state=active]:bg-transparent data-[state=active]:border-[#FDE047] data-[state=active]:text-[#FDE047] border-b-2 border-transparent px-0 rounded-none text-gray-300 hover:text-white "
              >
                ABOUT US
              </TabsTrigger>
              <TabsTrigger
